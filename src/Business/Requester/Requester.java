...
public class Requester {
    ...
    private AccountOfUser userAccount;
    ...
    public AccountOfUser getUserAccount() {
        return userAccount;
    }

    public void setUserAccount(AccountOfUser userAccount) {
    ...
    public Requester(AccountOfUser ua)
    {
        this.userAccount = ua;
    ...
    public AccountOfUser getReqAccount() {
        return userAccount;
    }

    public void setReqAccount(AccountOfUser reqAccount) {

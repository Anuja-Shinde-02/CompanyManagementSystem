...
public class Donor {
    ...
    private AccountOfUser donorAccount;
    ...
    public AccountOfUser getDonorAccount() {
        return donorAccount;
    }

    public void setDonorAccount(AccountOfUser donorAccount) {

...
public class FoodRequestPanel extends javax.swing.JPanel {
    ...
    public FoodRequestPanel(JPanel userProcessContainer,EcoSystem ecosystem,AccountOfUser userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(FoodRequestPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        //if(!nullCheck()){
            ...
            AccountOfUser ua=new AccountOfUser();

 ...
 */
public class AddingWarehousePanel extends javax.swing.JPanel {

    /**
     * Creates new form AddingWarehousePanel
     */
    private Image img;
    ...
    public AddingWarehousePanel(String img) {
    this(new ImageIcon(img).getImage());
  }
    public AddingWarehousePanel(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    public AddingWarehousePanel(Image img) {
    this.img = img;
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!nullCheck()){
            if(chkpwd()){
        AccountOfUserDirectory uaList = ecosystem.getUserAccountDirectory();
       ...
       ecosystem.setFCWDirectory(fcd);
        ...
        uad.createUserAccount(txtFCAuname.getText(), txtFCApwd.getText(), employee, new RoleOfFCAdmin());

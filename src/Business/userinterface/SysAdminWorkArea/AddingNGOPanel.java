 ...
 */
public class AddingNGOPanel extends javax.swing.JPanel {

    /**
     * Creates new form AddingNGOPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    NGODirectory ngod;
    AccountOfUserDirectory uad;
    public AddingNGOPanel(JPanel userProcessContainer, EcoSystem ecosystem) throws IOException {
        initComponents();
...
//        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!nullCheck()){
            ...
            ngoAccount.setRole(new RoleOfNgo());
            ngoAccount.setEmployee(employee);
            uad=ecosystem.getUserAccountDirectory();
            uad.createUserAccount(txtNGOAgentuname.getText(), txtNGOpwd.getText(), employee, new RoleOfNgo());

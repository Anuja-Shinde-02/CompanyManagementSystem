...
public class SysAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public SysAdminWorkAreaJPanel(JPanel userProcessContainer,EcoSystem ecosystem, JPanel jp, JSplitPane jsp) {
        initComponents();
    ...
    private void btnMgWHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMgWHActionPerformed
        ...
        ManagingWarehousePanel objWH = new ManagingWarehousePanel(userProcessContainer,ecosystem);
    ...
    private void btnMgPTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMgPTActionPerformed
        // TODO add your handling code here:
        ManagingPantryPanel objFCP = new ManagingPantryPanel(userProcessContainer,ecosystem);
    ...
    private void btnMgNGOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMgNGOActionPerformed
        try {
            // TODO add your handling code here:
            ManagingNGOJPanel objNGO = new ManagingNGOJPanel(userProcessContainer,ecosystem);
            SplitPaneSysAdmin.setRightComponent(objNGO);
        } catch (IOException ex) {
            Logger.getLogger(SysAdminWorkAreaJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnMgUsersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMgUsersActionPerformed
        // TODO add your handling code here:
        ManagingUsersPanel objUSER = new ManagingUsersPanel(userProcessContainer,ecosystem);

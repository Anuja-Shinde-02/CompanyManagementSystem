 ...
 */
public class ModifiedNGOPanel extends javax.swing.JPanel {

    /**
     * Creates new form ModifiedNGOPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    NGODirectory ngod;
    public ModifiedNGOPanel(JPanel userProcessContainer, EcoSystem ecosystem) throws IOException {
        initComponents();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        for(NGO f: ngoList)
        {
            if(f.getNgoId().equals(NGOid))
            {
                ...
                AccountOfUser NGOua=new AccountOfUser();

...
public class AddVolunteerPanel extends javax.swing.JPanel {
    ...
    String ngoName;
    public AddVolunteerPanel(JPanel userProcessContainer,EcoSystem ecosystem,AccountOfUser userAcc) {
        initComponents();
...
//        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!nullCheck()){
            ...
            AccountOfUser volAccount=new AccountOfUser();
            ...
            volAccount.setRole(new TheDeliveryVolunteer());
            volAccount.setEmployee(employee);
            vol.setVolAvail("New");
            vol.setVolNGO(ngoName);
            uad=ecosystem.getUserAccountDirectory();
            uad.createUserAccount(txtVoluname.getText(), txtVolpwd.getText(), employee, new TheDeliveryVolunteer());

...
public class ManageUsersPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblMgUsersTitle.setFont(new java.awt.Font("Lucida Handwriting", 1, 24)); // NOI18N
        lblMgUsersTitle.setForeground(new java.awt.Color(255, 93, 119));
        ...
        add(logoImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));
   ...
   //     headerRenderer.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (selectedRowIndex < 0) {
            //you have to select the record to delete 
        ...
        if(selectedUA.getRole().toString().equals("Business.Role.SystemAdminRole")){
            ...
            //you are not able to delete the System Admin login
            ...
            //user is allowed to delete warehouse or update admin name
            JOptionPane.showMessageDialog(this, "You cannot delete this login!"
                    + "You can delete the warehouse or update the admin name only");
        }
        else if(selectedUA.getRole().toString().equals("Business.Role.FCPManagerRole")){
            //user is allowed to delete pantry or update agent name
             JOptionPane.showMessageDialog(this, "You cannot delete this login!"
                    + "You can delete the pantry or update the manager name only");
        }
        else if(selectedUA.getRole().toString().equals("Business.Role.NgoRole")){
            JOptionPane.showMessageDialog(this, "You cannot delete this login!"
                    + "You can delete the ngo or update the agent name only");
        }
        else{
        ...
        //after selcting and clicking on delete button the user account will be deleted Successfully
    ...
    private void populateUserTable() {
        //DefaultTableModel initializes the table by passing data and columnNames 
        DefaultTableModel model = (DefaultTableModel) tblUsers.getModel();
        model.setRowCount(0);

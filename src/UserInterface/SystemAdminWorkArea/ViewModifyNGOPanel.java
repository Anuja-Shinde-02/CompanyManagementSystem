...
//        imageLbl.setIcon(new ImageIcon(newimg));
    ...
    private void initComponents() {
        ...
        tblNGODetails = new javax.swing.JTable();
        ...
        add(lblAddNGOTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, 190, 40));

        tblNGODetails.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblNGODetails.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tblNGODetailsMousePressed(evt);
            }
        });
        jScrollPane1.setViewportView(tblNGODetails);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 820, 130));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 230, 92, -1));
        ...
        add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 230, 92, -1));
        ...
        lblNGOuname.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblNGOpwd1, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(46, 46, 46)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblNGOname1, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
     ...
     public void setBG() {
      ...
      public void makeTableTransparent() {
        tblNGODetails.setOpaque(false);
        ((DefaultTableCellRenderer) tblNGODetails.getDefaultRenderer(Object.class)).setOpaque(false);
        tblNGODetails.setShowGrid(false);
        ...
        for (int i = 0; i < tblNGODetails.getModel().getColumnCount(); i++) {
            tblNGODetails.getColumnModel().getColumn(i).setHeaderRenderer(headerRenderer);
        }
    }
     
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        int selectedRowIndex = tblNGODetails.getSelectedRow();
        ...
        DefaultTableModel model = (DefaultTableModel) tblNGODetails.getModel();
        ...
        //NGO record will be deleted successfully
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if(selectedRowIndex < 0){
            ...
            //you have to select a record from the table that you wish to Edit
            JOptionPane.showMessageDialog(this, "Please select a record to Edit");
            return;
        }
        
        //DefaultTableModel is a implementation of TableModel that uses Vector of Vectors for storing the cell value objects.
        DefaultTableModel model = (DefaultTableModel) tblNGODetails.getModel();
        NGO selectedNGO = (NGO)model.getValueAt(selectedRowIndex, 0);
    ...
    private void txtNGOnameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOnameFocusLost
        ...
        if(!(txtNGOname.getText().matches("^[a-zA-Z]*$"))){
             ...
             //you will have to add the NGO Name in alphabets only. 
    ...
    private void txtNGOZipFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOZipFocusLost
        ...
        if((txtNGOZip.getText().matches("^[a-zA-Z]*$"))){
            ...
            //you will have to add the NGO ZipCode in numbers only.
    ...
    private void txtNGOAgentFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOAgentFocusLost
        ...
        if(!(txtNGOAgent.getText().matches("^[a-zA-Z]*$"))){
             ...
             //you will have to add the NGO Agent in alphabets only.
            lblNGOAgent1.setText("Input invalid. Please enter only alphabets");
        }
        else{
    ...
    private void tblNGODetailsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblNGODetailsMousePressed
        // TODO add your handling code here:
         tblNGODetails.setSelectionForeground(Color.BLUE);
    }//GEN-LAST:event_tblNGODetailsMousePressed
    ...
    private javax.swing.JTable tblNGODetails;

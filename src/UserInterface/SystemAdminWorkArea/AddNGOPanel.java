...
public class AddNGOPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblAddNGOTitle.setFont(new java.awt.Font("Lucida Handwriting", 1, 24)); // NOI18N
        lblAddNGOTitle.setForeground(new java.awt.Color(255, 93, 119));
        lblAddNGOTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblAddNGOTitle.setText("! Add NGO !");
        add(lblAddNGOTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 30, -1, -1));

        lblNGOname.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOname.setText("NGO Name :");
        add(lblNGOname, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 150, 100, -1));
        ...
        lblNGOPhno.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOPhno.setText("Phone Number :");
        add(lblNGOPhno, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, -1, 30));
        ...
        lblNGOAdd.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOAdd.setText("Address :");
        add(lblNGOAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 80, 20));
        ...
        lblNGOCity.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOCity.setText("City :");
        add(lblNGOCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, -1, -1));
        ...
        lblNGOState.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        ...
        lblNGOZip.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        ...
        lblNGOAgent.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        ...
        lblNGOAgentuname.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOAgentuname.setText("NGO Agent Username :");
        add(lblNGOAgentuname, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 440, -1, -1));
        ...
        lblNGOpwd.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOpwd.setText("Password :");
        add(lblNGOpwd, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 490, -1, -1));
        ...
        lblNGOcopwd1.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOcopwd1.setText("Confirm Password :");
        add(lblNGOcopwd1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 530, -1, -1));
        ...
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 580, 90, 40));

        lblNGOid.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        lblNGOid.setText("NGO Id :");
        add(lblNGOid, new org.netbeans.lib.awtextra.AbsoluteConstraints(243, 110, 70, -1));
        ...
        add(lblNGOid2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 90, 140, 30));

        lblNGOname1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        add(lblNGOname1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 130, 140, 30));

        lblNGOPhno1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        add(lblNGOPhno1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 180, 140, 30));

        lblNGOZip1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        add(lblNGOZip1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 350, 140, 30));

        lblNGOAdmin1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        add(lblNGOAdmin1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 390, 140, 30));

        lblNGOpwd2.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        add(lblNGOpwd2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 520, 140, 30));
        ...
        add(btnCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 580, 80, 40));
    ...
    private void txtNGOnameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOnameFocusLost
        ...
        if(!(txtNGOname.getText().matches("^[a-zA-Z]*$"))){
            ...
            //in the add NGO you will have to add the NGO Name in alphabets only.
            lblNGOname1.setText("Input invalid. Please enter only alphabets");
        }
        else{
            lblNGOname1.setText("");
        }
    ...
    private void txtNGOPhnoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOPhnoFocusLost
        ...
        if(!(txtNGOPhno.getText().matches("^[0-9]*$")) || !(txtNGOPhno.getText().length()==10)) {
            ...
            //in the add NGO you will have to add the Phone Number in numbers only.
    ...
    private void txtNGOZipFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOZipFocusLost
        ...
        if((txtNGOZip.getText().matches("^[a-zA-Z]*$"))){
            ...
            //in the add NGO you will have to add the Zip Code in numbers only.
            lblNGOZip1.setText("Input invalid. Please enter only numbers");
    ...
    private void txtNGOAgentFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOAgentFocusLost
        ...
        if(!(txtNGOAgent.getText().matches("^[a-zA-Z]*$"))){
            ...
            //in the add NGO you will have to add the NGO Agent in alphabets only.
            lblNGOAdmin1.setText("Input invalid. Please enter only alphabets.");
        }
        else{
...
//        }
    ...
    private void txtNGOidFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNGOidFocusLost
        ...
        if((txtNGOid.getText().matches("^[a-zA-Z]*$"))){
           ...
           //in the add NGO you will have to add the NGO ID in numbers only.
            lblNGOid2.setText("Input invalid. Please enter only numbers");
        }
        else{
            lblNGOid2.setText("");
        }

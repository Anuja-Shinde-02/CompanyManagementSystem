 ...
 * @author anujashinde
 */
public class FoodNGOWorkAreaPanel extends javax.swing.JPanel {

    /**
     * Creates new form FoodNGOWorkAreaPanel
     */
    ...
    JPanel jp;
    JSplitPane jsp;
    public FoodNGOWorkAreaPanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount userAcc, JPanel jp, JSplitPane jsp) {
        initComponents();
    ...
    private void btnManagevolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManagevolActionPerformed
        ...
        ManageFoodNGOVolunteersPanel objViewDon = new ManageFoodNGOVolunteersPanel(userProcessContainer,ecosystem,userAcc, jp, jsp);
        SplitPaneDon.setRightComponent(objViewDon);
    }//GEN-LAST:event_btnManagevolActionPerformed

    private void btnProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileActionPerformed
        // TODO add your handling code here:
        FoodNGOProfilePanel objNGOProf = new FoodNGOProfilePanel(userProcessContainer,ecosystem,userAcc);
    ...
    private void lbllogoutMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbllogoutMousePressed
        ...
        try {
            ...
            Logger.getLogger(FoodNGOWorkAreaPanel.class.getName()).log(Level.SEVERE, null, ex);
        }

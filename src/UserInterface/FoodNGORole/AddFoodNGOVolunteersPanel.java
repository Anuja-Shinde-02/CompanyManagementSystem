 ...
 * @author anujashinde
 */
public class AddFoodNGOVolunteersPanel extends javax.swing.JPanel {

    /**
     * Creates new form AddFoodNGOVolunteersPanel
     */
    ...
    String ngoName;
    public AddFoodNGOVolunteersPanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(AddFoodNGOVolunteersPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!nullCheck()){
            ...
            FoodNGOVolunteers vol = new FoodNGOVolunteers();

...
import Business.FoodNGO.FoodNGO;
import Business.FoodNGO.FoodNGODirectory;
 ...
 * @author anujashinde
 */
public class FoodNGOProfilePanel extends javax.swing.JPanel {

    /**
     * Creates new form FoodNGOProfilePanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    FoodNGOVolunteersDirectory vold;
    UserAccount userAcc;
    FoodNGODirectory ngod;
    String NGOUname;
    String ngoAname;
    boolean validateName = false, validatePhone =false, validateAdd =false, validate; 
    public FoodNGOProfilePanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(FoodNGOProfilePanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        // TODO add your handling code here:
        if(!nullCheck()){
            ArrayList<FoodNGO> ngoList = ecosystem.getNgoDir().getNgoList();
            for(FoodNGO d: ngoList)
            {
    ...
    private void populateFields() {
        for(FoodNGO d: ecosystem.getNgoDir().getNgoList()){

...
import Business.FoodNGOVolunteers.FoodNGOVolunteersRequests;
 ...
 * @author anujashinde
 */
public class FoodRequestsPanel extends javax.swing.JPanel {
    ...
    public FoodRequestsPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount userAcc) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.ecosystem = ecosystem;
        this.userAcc = userAcc;
        ngoAName = userAcc.getEmployee().getName();
        for (FoodNGO ng : ecosystem.getNgoDir().getNgoList()) {
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(ManageFoodNGOVolunteersPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnAvailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvailActionPerformed
        ...
        FoodNGOVolunteers selectedV = (FoodNGOVolunteers) model.getValueAt(selectedRowIndex, 0);
        if (selectedV.getVolAvail().equals("New") || selectedV.getVolAvail().equals("No")) {
            selectedV.setVolAvail("Yes");
            String reqidval = lblR.getText();
            for (FoodNGOVolunteersRequests vr : ecosystem.getVRDirectory().getVrList()) {
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        FoodNGOVolunteersRequests selectedVR = (FoodNGOVolunteersRequests) model.getValueAt(selectedRowIndex, 0);

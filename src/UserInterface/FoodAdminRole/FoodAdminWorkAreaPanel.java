 ...
 * @author anujashinde
 */
public class FoodAdminWorkAreaPanel extends javax.swing.JPanel {

    /**
     * Creates new form FoodAdminWorkAreaPanel
     */
    ...
    JPanel jp;
    JSplitPane jsp;
    public FoodAdminWorkAreaPanel(JPanel userProcessContainer,EcoSystem ecosystem, UserAccount userAccount, JPanel jp, JSplitPane jsp) {
        initComponents();
    ...
    private void btnViewDonReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDonReqActionPerformed
        ...
        FoodDonationRequestsPanel objDonReq =  new FoodDonationRequestsPanel(userProcessContainer,ecosystem,userAccount);
    ...
    private void btnMgPTitemsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMgPTitemsActionPerformed
        // TODO add your handling code here:
        ManageFoodPantryItemsPanel objWHI = new ManageFoodPantryItemsPanel(userProcessContainer,ecosystem,userAccount);
    ...
    private void btnMgVolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMgVolActionPerformed
        // TODO add your handling code here:
        ManageFoodVolunteersPanel objVol =  new ManageFoodVolunteersPanel(userProcessContainer,ecosystem,userAccount);
    ...
    private void lbllogoutMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbllogoutMousePressed
        ...
        try {
            ...
            Logger.getLogger(FoodAdminWorkAreaPanel.class.getName()).log(Level.SEVERE, null, ex);
        }

 ...
 * @author anujashinde
 */
public class FoodDonationRequestsPanel extends javax.swing.JPanel {
    ...
    String WHname;
    String city;
    public FoodDonationRequestsPanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(ViewFoodPantryItemsPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
  ...
  public void makeTableTransparent() {
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        for(FoodNGOVolunteers v:ecosystem.getVolDir().getVolunteerList()){

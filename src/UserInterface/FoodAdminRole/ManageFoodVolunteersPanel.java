...
import Business.FoodNGOVolunteers.FoodNGOVolunteersRequestsDirectory;
 ...
 * @author anujashinde
 */
public class ManageFoodVolunteersPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageFoodVolunteersPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    UserAccount userAcc;
    FoodNGOVolunteersDirectory vold;
    FoodNGOVolunteersRequestsDirectory vrD;
    String WHname;
    String city;
    public ManageFoodVolunteersPanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount userAcc) {
        initComponents();
        ...
        populateTable();
         ...
         ecosystem.setVRDirectory(new FoodNGOVolunteersRequestsDirectory());
        }
    ...
    private void btnReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReqActionPerformed
        ...
        FoodNGOVolunteersRequests vr = new FoodNGOVolunteersRequests();
        vr.setVolreqId("1");

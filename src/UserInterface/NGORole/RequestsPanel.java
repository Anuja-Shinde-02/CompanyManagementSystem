...
public class RequestsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblRequestPanelTitle.setFont(new java.awt.Font("Lucida Handwriting", 1, 24)); // NOI18N
        lblRequestPanelTitle.setForeground(new java.awt.Color(255, 93, 119));
        lblRequestPanelTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblRequestPanelTitle.setText("! Requests for Food !");
        add(lblRequestPanelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 700, 140));

        btnAvail.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
        btnAvail.setText("Make Available");
        btnAvail.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnAvail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAvailActionPerformed(evt);
            }
        });
        add(btnAvail, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 530, 150, 30));

        tblVolunteerAvail.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(tblVolunteerAvail);

        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 814, 153));

        btnProcess.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
        ...
        add(btnProcess, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 230, 90, 30));

        lblWarehouse.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        lblWarehouse.setText("For Warehouse:");
        add(lblWarehouse, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, -1, -1));

        lblW.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        add(lblW, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 120, 20));

        lblRequestID.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        lblRequestID.setText("Request ID:");
        add(lblRequestID, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, -1, -1));

        lblR.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        add(lblR, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 280, 110, 20));
    ...
    public void makeTableTransparent1() {
        tblVolunteerAvail.setOpaque(false);
        ((DefaultTableCellRenderer) tblVolunteerAvail.getDefaultRenderer(Object.class)).setOpaque(false);
        tblVolunteerAvail.setShowGrid(false);
        jScrollPane2.setOpaque(false);
        jScrollPane2.getViewport().setOpaque(false);

        //DefaultTableCellRenderer -The default class for rendering (displaying) individual cells in a JTable. static class.
        DefaultTableCellRenderer headerRenderer = new DefaultTableCellRenderer();
        headerRenderer.setBackground(Color.WHITE);

        for (int i = 0; i < tblVolunteerAvail.getModel().getColumnCount(); i++) {
            tblVolunteerAvail.getColumnModel().getColumn(i).setHeaderRenderer(headerRenderer);
        }
    }
    ...
    private void btnAvailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvailActionPerformed
        ...
        int selectedRowIndex = tblVolunteerAvail.getSelectedRow();
        if (selectedRowIndex < 0) {
            JOptionPane.showMessageDialog(this, "Please select a request");
            return;
        }
        DefaultTableModel model = (DefaultTableModel) tblVolunteerAvail.getModel();
        ...
        if (selectedV.getVolAvail().equals("New") || selectedV.getVolAvail().equals("No")) {
            ...
            //this means volunteer is already assigned 
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        if (selectedVR.getVolreqStatus().equals("Completed")) {
            ...
            tblVolunteerAvail.setVisible(true);

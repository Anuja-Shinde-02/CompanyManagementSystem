 ...
 */
public class ProfileRequestPanel extends javax.swing.JPanel {

    /**
     * Creates new form ProfileRequestPanel
     */
    ...
    String reqUname;
    String reqName;
    RequesterDirectory reqDir;
    public ProfileRequestPanel(JPanel userProcessContainer,EcoSystem ecosystem,AccountOfUser userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(ProfileRequestPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        // TODO add your handling code here:
        if(!nullCheck()){
            ArrayList<Requester> reqList = ecosystem.getReqDir().getReqAccList();
            for(Requester r: reqList)
            {
    ...
    private void populateFields() {
        for(Requester r: ecosystem.getReqDir().getReqAccList()){

 ...
 */
public class OrderRequestStatusPanel extends javax.swing.JPanel {

    /**
     * Creates new form OrderRequestStatusPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    AccountOfUser userAcc;
    public OrderRequestStatusPanel(JPanel userProcessContainer,EcoSystem ecosystem,AccountOfUser userAcc) {
        initComponents();
    ...
    public void setBG() {
        try {
            ...
            Logger.getLogger(OrderRequestStatusPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

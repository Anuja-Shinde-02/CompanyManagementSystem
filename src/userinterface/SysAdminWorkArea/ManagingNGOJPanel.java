 ...
 */
public class ManagingNGOJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManagingNGOJPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;

    public ManagingNGOJPanel(JPanel userProcessContainer, EcoSystem ecosystem) throws IOException {
        initComponents();
    ...
    private void btnAddNGOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNGOActionPerformed
        try {
            ...
            AddingNGOPanel objAddNGO = new AddingNGOPanel(userProcessContainer,ecosystem);
            SplitPaneNGO.setRightComponent(objAddNGO);
        } catch (IOException ex) {
            Logger.getLogger(ManagingNGOJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnViewNGOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewNGOActionPerformed
        try {
            // TODO add your handling code here:
            ModifiedNGOPanel objViewModNGO = new ModifiedNGOPanel(userProcessContainer,ecosystem);

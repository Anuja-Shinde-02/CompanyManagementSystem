 ...
 */
public class ModifiedWarehousePanel extends javax.swing.JPanel {

    /**
     * Creates new form ModifiedWarehousePanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    FCWarehouseDirectory fcd;
    public ModifiedWarehousePanel(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        for(FCWarehouse f: fcwList)
        {
            if(f.getFcwId().equals(WHid))
            {
                ...
                //UserAccount WHua=new AccountOfUser();

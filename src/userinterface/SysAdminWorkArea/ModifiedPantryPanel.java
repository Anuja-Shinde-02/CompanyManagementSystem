 ...
 */
public class ModifiedPantryPanel extends javax.swing.JPanel {

    /**
     * Creates new form ModifiedPantryPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    FCPantryDirectory fcpd;
    public ModifiedPantryPanel(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        for(FCPantry f: fcpList)
        {
            if(f.getFcpId().equals(FCPid))
            {
                ...
                //UserAccount FCPua=new AccountOfUser();

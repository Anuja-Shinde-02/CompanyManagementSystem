 ...
 */
public class AddingFCPantryPanel extends javax.swing.JPanel {

    /**
     * Creates new form AddingFCPantryPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    FCPantryDirectory fcpd;
    AccountOfUserDirectory uad;
    public AddingFCPantryPanel(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!nullCheck()){
            ...
            AccountOfUser fcpAccount=new AccountOfUser();
            fcpAccount.setUsername(txtFCPuname.getText());
            fcpAccount.setPassword(txtFCPpwd.getText());
            fcpAccount.setRole(new RoleOfFCPManager());
            fcpAccount.setEmployee(employee);
            uad=ecosystem.getUserAccountDirectory();
            uad.createUserAccount(txtFCPuname.getText(), txtFCPpwd.getText(), employee, new RoleOfFCPManager());

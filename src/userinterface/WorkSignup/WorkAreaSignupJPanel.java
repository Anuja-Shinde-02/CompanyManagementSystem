 ...
 */
package userinterface.WorkSignup;
...
import Business.AssignedRole.RoleOfAdmin;
import Business.AssignedRole.RoleOfCustomer;
 ...
 */
public class WorkAreaSignupJPanel extends javax.swing.JPanel {

    /**
     * Creates new form WorkAreaSignupJPanel
     */
    EcoSystem ecosystem;
    ...
    public WorkAreaSignupJPanel(JPanel userProcessContainer, EcoSystem ecosystem) throws IOException {
        
        this.ecosystem = ecosystem;
        this.userProcessContainer = userProcessContainer;

        if (ecosystem.getReqDir()== null) {
            ecosystem.setReqDir(new RequesterDirectory());
        }
    ...
    private void btnHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHomeActionPerformed
        try {
            ...
            Logger.getLogger(WorkAreaSignupJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        AccountOfUserDirectory usersList = ecosystem.getUserAccountDirectory();
        String role = (String) cmbLoginType.getSelectedItem();
        Employee employee = new Employee();
        employee.setName(txtName.getText());
        boolean userDoNotExists = true;
        ArrayList<AccountOfUser> users = usersList.getUserAccountList();
        for (AccountOfUser ua : users) {
        ...
        if (userDoNotExists) {
            if (txtPwd.getText().equals(txtCnfPwd.getText())) {
                switch (role) {
                    case "Food Requestor":
                        usersList.createUserAccount(txtUserName.getText(), txtPwd.getText(), employee, new RoleOfRequester());
                        ua = usersList.getUserAccount(txtUserName.getText());
                        req = new Requester(ua);
                    ...
                    case "Food Donor":
                        usersList.createUserAccount(txtUserName.getText(), txtPwd.getText(), employee, new RoleOfDonor());
                        ua = usersList.getUserAccount(txtUserName.getText());
                        don = new Donor(ua);
